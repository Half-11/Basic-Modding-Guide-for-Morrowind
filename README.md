...
Although the amount of information might be intimidating at first glance, the modlist itself is pretty basic (8 mods for the essential part, and another 9 for vanilla+). The information is there so you know exactly what to do in each scenario.
