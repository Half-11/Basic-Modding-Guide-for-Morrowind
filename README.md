...
```
   - I'm of the opinion that [the official plugins](https://en.uesp.net/wiki/Morrowind:Plugins) are pretty shitty. They are buggy, have balance issues, don't fit the vanilla game, and are nothing like modern day DLC. If you ask me, only two are worth playing really: Bitter Coast Sounds & Master Index (and maybe Siege at Firemoth, if you're in the mood for mowing through hordes of skeletons and can get past its poor balance and bad level design). If you want to play with these mods, you could take a look at the [fixed versions in UMOPP](https://www.nexusmods.com/morrowind/mods/43931). I would ignore the **Merged and Compatibility Versions** and go with the **UMOPP 3.1.0** file. This way you can make your own selection.
