...
```
   ...
   - *The official plugins are pretty buggy and in my opinion only a few are worth playing (Bitter Coast Sounds, Master Index, Siege at Firemoth). If you want to play with these mods, you could take a look at the [fixed versions in UMOPP 3.0.4](https://www.nexusmods.com/morrowind/mods/43931) (ignore the Merged and Compatibility Versions file).*
