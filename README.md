...
- Finally, a word of advice. Take it or leave it. Modding can be a great activity to relax and take your mind of things. However, speaking from my own experiences, it can also be [addictive and take on unhealthy forms](https://www.youtube.com/watch?v=9QiE-M1LrZk). When you find yourself in an endless loop of modding, trying to achieve this "perfectly modded game", ask yourself the question: “Is this really quality relaxing time?” Take care!
