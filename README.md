...
```
   ...
   - I'm of the opinion that [the official plugins](https://en.uesp.net/wiki/Morrowind:Plugins) are pretty shitty. They are buggy, have balance issues, don't fit the vanilla game, and are nothing like modern day DLC. If you ask me, only two are worth playing really: Bitter Coast Sounds & Master Index. If you want to play with these mods, you could take a look at the [fixed versions in UMOPP 3.0.4](https://www.nexusmods.com/morrowind/mods/43931) (I would ignore the Merged and Compatibility Versions and go with the UMOPP 3.0.4 file).
