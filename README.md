...
5. [Download the EdgeAA shader for MGE XE](https://cdn.discordapp.com/attachments/381217735306248192/609149467962376224/EdgeAA.zip). Extract the zip to your ```Morrowind``` root folder. We need this shader later on in the guide.
