...
- Finally, a word of advice. Take it or leave it. Modding can be a great activity to take your mind off things. However, speaking from my own experiences, it can also be addictive and [take on unhealthy forms](https://www.youtube.com/watch?v=9QiE-M1LrZk). When you find yourself in an endless loop of modding, trying to achieve this "perfectly modded game", ask yourself if this is really quality relaxing time.
