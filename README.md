...
* [7-Zip](https://www.7-zip.org/download.html) or [WinRAR](https://www.win-rar.com/start.html?&L=16) - If you have no file archiver installed on your computer I would recommened installing one. All mods on Nexus will be downloaded as one archive file (.7z/.rar/.zip files). 7-Zip is one of the best-known utilities for unpacking such archives into their orginal state.
...
```
   - I'm of the opinion that [the official plugins](https://en.uesp.net/wiki/Morrowind:Plugins) are pretty shitty. They are buggy, have balance issues, don't fit the vanilla game, and are nothing like modern day DLC. If you ask me, only two are worth playing really: Bitter Coast Sounds & Master Index. If you want to play with these mods, you could take a look at the [fixed versions in UMOPP](https://www.nexusmods.com/morrowind/mods/43931). I would ignore the **Merged and Compatibility Versions** and go with the **UMOPP 3.1.0** file. This way you can make your own selection.
