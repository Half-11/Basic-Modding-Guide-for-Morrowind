...
* [Microsoft Visual C++ 2015 Redistributable (x86)](https://www.microsoft.com/en-us/download/details.aspx?id=48145) - This is another requirement for third-party software later in this guide.
     - *Instructions: Select your language. Click the **Download** button. Check the box before **vc_redist.x86.exe**. Click the **Next** button (or use this [direct link](https://aka.ms/vs/16/release/vc_redist.x86.exe)).*
